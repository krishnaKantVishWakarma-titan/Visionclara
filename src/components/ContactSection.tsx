export function ContactSection() {
  return (
    <div className="max-w-6xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16 mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
              <div className="flex gap-4">
                ...
                <div className="grow">
                  ...
                  <p>
                    <a className="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white" href="mailto:contact@visionclara.com">
                      contact@visionclara.in
                    </a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="grow">
                  ...
                  <p>
                    <a className="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white" href="tel:+917697114202">
                      +91 7697114202
                    </a>
                  </p>
                </div>
